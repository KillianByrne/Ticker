...
define("propertyParser", function () { function c(b) { for (var c, e = {}; c = a.exec(b) ;) e[c[1]] = d(c[2] || c[3]); return e } function d(a) { return b.test(a) ? a = a.replace(b, "$1").split(",") : "null" === a ? a = null : "false" === a ? a = !1 : "true" === a ? a = !0 : "" === a || "''" === a || '""' === a ? a = "" : isNaN(a) || (a = +a), a } var a = /([\w-]+)\s*:\s*(?:(\[[^\]]+\])|([^,]+)),?/g, b = /^\[([^\]]+)\]$/; return { parseProperties: c, typecastVal: d } });
define("goog", ["async", "propertyParser"], function (a, b) { function d(a) { var d = c.exec(a), e = { moduleName: d[1], version: d[2] || "1" }; return e.settings = b.parseProperties(d[3]), e } var c = /^([^,]+)(?:,([^,]+))?(?:,(.+))?/; return { load: function (a, b, c, e) { if (e.isBuild) c(null); else { var f = d(a), g = f.settings; g.callback = c, b(["async!" + ("https:" === document.location.protocol ? "https" : "http") + "://www.google.com/jsapi"], function () { google.load(f.moduleName, f.version, g) }) } } } });
