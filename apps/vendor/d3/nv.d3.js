    ...
    function chart(selection) {
        selection.each(function(data) {
            ...
            if (align) {
                ...
                if (rightAlign) {
                    g.attr('transform', 'translate(' + (width - margin.right - isNaN(legendWidth) ? 0 : legendWidth) + ',' + margin.top + ')');
                }
                else {
...
nv.models.linePlusBarChart = function() {
    ...
    function chart(selection) {
        selection.each(function(data) {
            ...
            g.select('.nv-context').style('display', 'none');
...
nv.models.singleBarChart = function () {
        "use strict";
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                // hide or show the focus context chart
                g.select('.nv-context').style('display', 'none');
                g.select('.nv-context .nv-linesWrap').style('display', 'none');
                bars2
                    .width(availableWidth)
                    .height(availableHeight2)
                    .color(data.map(function (d, i) {
                ...
                onBrush();
                g.select('.nv-context .nv-linesWrap').style('opacity', 0);
            });
...
nv.models.pathfinder= function () {
    ...
    var margin = { top: 5, right: 30, bottom: 10, left: 60 }
        , margin2 = { top: 0, right: 5, bottom: 10, left: 60 }
        , color = nv.utils.defaultColor()
        , width = null
        , height = null
        , height2 = 30
    ...
    function chart(selection) {
        selection.each(function (data) {
            ...
            yAxis
                .scale(y)
                .ticks(nv.utils.calcTicksY(availableHeight1 / 60, data))
                .tickSize(-availableWidth, 0);
...
nv.models.multiBarChart = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
                       ...
                       .map(function (d, i) {
                           return {
                               ...
                               values: d.values.filter(function (d, i) {
                                   var multibarData;
                                   if (extent) {
                                       multibarData = multibar.x()(d, i) >= extent[0] && multibar.x()(d, i) <= extent[1];
                                   } else {
                                       multibarData = multibar.x();
                                   }
                                   return multibarData;
                               })
                           }
            ...
            //dispatch.on('brushExtent', function (e) {
            //    if (brushExtent) brushExtent(e)
            //});
                       ...
                       .map(function (d, i) {
                           return {
                               ...
                               values: d.values.filter(function (d, i) {
                                   var bubbleData;
                                   if (extent) {
                                       bubbleData = scatter.x()(d, i) >= extent[0] && scatter.x()(d, i) <= extent[1];
                                   } else {
                                       bubbleData = scatter.x();
                                   }
                                   return bubbleData;
                               })
                           }
...
nv.models.stackedAreaChart = function() {
    ...
    var margin = {top: 30, right: 25, bottom: 50, left: 60}
        ...
        , defaultState = null
        , noData = 'No Data Available.'
        , dispatch = d3.dispatch('tooltipShow', 'tooltipHide', 'stateChange', 'changeState','renderEnd','iClicked')
        , controlWidth = 250
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
                       ...
                       .map(function (d, i) {
                           return {
                               ...
                               values: d.values.filter(function(d, i) {
                                   var stackedData;
                                   if (extent) {
                                       stackedData = stacked.x()(d, i) >= extent[0] && stacked.x()(d, i) <= extent[1];
                                   } else {
                                       stackedData = stacked.x();
                                   }
                                   return stackedData;
                               })
                           };
            ...
            dispatch.on('iClicked', function (e) {
            ...
            interactiveLayer.dispatch.on('elementMousemove', function(e) {
                ...
                data
                    ...
                    .forEach(function(series,i) {
                        ...
                        var tooltipValue = (stacked.stylei() == 'expand') ? point.display.y : chart.y()(point,pointIndex);
                        allData.push({
                            key: series.key,
                            value: tooltipValue,
                            color: color(series,series.seriesIndex),
