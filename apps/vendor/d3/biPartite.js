var biPartite = function (colors, height, bb, decimalPlaces, c1, c2, c3, partWidth, min,displayLabel,displayValue,displayPercent) {
    var bP = {};
    var b = min;
    var buffMargin = 1;
    var minHeight = min;
    ...
    function drawPart(data, id, p) {
        ...
        mainbar.append("text").attr("class", "barvalue")
			...
			.text(function (d, i) { return d.value.toFixed(decimalPlaces); })
			.attr("text-anchor", "start")
            .attr("display", displayValue);

        mainbar.append("text").attr("class", "barpercent")
			.attr("x", c3[p]).attr("y", function (d) { return d.middle + 5; })
			.text(function (d, i) { return "( " + (d.percent * 100).toFixed(decimalPlaces) + "%)"; })
